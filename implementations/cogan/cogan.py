...
for epoch in range(opt.n_epochs):
    for i, ((imgs1, _), (imgs2, _)) in enumerate(zip(dataloader1, dataloader2)):
        ...
        # Determine validity of generated mnist_images
        ...
        # Determine validity of real and generated mnist_images
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            save_image(gen_imgs, "mnist_images/%d.png" % batches_done, nrow=8, normalize=True)
