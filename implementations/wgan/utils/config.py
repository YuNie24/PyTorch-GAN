...
def parse_args():
    ...
    parser.add_argument('--models', type=str, default='DCGAN', choices=['GAN', 'DCGAN', 'WGAN-CP', 'WGAN-GP'])
    parser.add_argument('--is_train', type=str, default='True')
    parser.add_argument('--dataroot', help='path to dataset')
    parser.add_argument('--dataset', type=str, default='bedroom', choices=['mnist', 'fashion-mnist', 'cifar', 'stl10', 'bedroom'],
